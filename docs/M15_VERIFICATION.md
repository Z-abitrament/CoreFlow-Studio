...
filling trials. The delivered baseline is software version `0.7.2` with SQLite
schema v4.
...
- `pyproject.toml` contains version `0.7.2`.
- `src/coreflow/__init__.py` contains `__version__ = "0.7.2"`.
