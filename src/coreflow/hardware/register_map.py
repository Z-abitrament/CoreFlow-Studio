    ...
    return ModbusRegisterMap(
        ...
        registers=(
            ...
            ModbusRegister(
                ...
                data_type=ModbusDataType.FLOAT32,
                unit="kg/s",
                description="Alias placeholder for mass-rate input register.",
                metadata={**placeholder, "alias_for": "mass_flow"},
            ),
            ModbusRegister(
                name="mass_acc",
                kind=RegisterKind.INPUT,
                ...
                data_type=ModbusDataType.FLOAT32,
                unit="kg",
                description="Placeholder accumulated mass register.",
                metadata=placeholder,
            ),
            ModbusRegister(
                name="volume_flow",
            ...
            ModbusRegister(
                ...
                data_type=ModbusDataType.FLOAT32,
                unit="us",
                description="Placeholder Delta T register.",
                metadata=placeholder,
            ),
            ModbusRegister(
                name="frequency",
                ...
                data_type=ModbusDataType.FLOAT32,
                unit="Hz",
                description="Placeholder tube frequency register.",
                metadata=placeholder,
            ),
            ModbusRegister(
                name="device_status",
            ...
            ModbusRegister(
                ...
                minimum=0.0,
                maximum=1000000.0,
                description="Placeholder writable K factor parameter.",
                metadata={
                    **placeholder,
                    "write_requires": "application write guard, operator approval, and hardware acceptance procedure",
                },
            ...
            ModbusRegister(
                ...
                maximum=1000000.0,
                unit="kg/s",
                description="Placeholder writable low-flow threshold parameter.",
                metadata={
                    **placeholder,
                    "write_requires": "application write guard, operator approval, and hardware acceptance procedure",
                },
            ...
            ModbusRegister(
                ...
                writable=True,
                description="Placeholder coil: write true to start zero calibration, read false when complete.",
                metadata={
                    **placeholder,
                    "write_requires": "application write guard, operator approval, and hardware acceptance procedure",
                },
